  ...
  app.post('/api/send-order', upload.single('archivo'), async (req: any, res: any) => {
    try {
      ...
      const { 
        ...
        entregaTipo, sede, ciudad, direccion, barrio, localidad, cuotas, metodoPago 
      } = orderData;
