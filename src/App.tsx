...
const SEDES = ["Plaza Claro", "Sede Ortezal", "Sede Torres de Suba", "Sede Claro 5", "Sede Triara", "CAVS"];
                ...
                {formData.metodoPago === 'contado' ? (
                  <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 mb-4">
                    <p className="text-sm text-blue-800 leading-relaxed">
                      Para finalizar su pedido, por favor realice la consignación a favor de <strong>FonClaro</strong>:<br />
